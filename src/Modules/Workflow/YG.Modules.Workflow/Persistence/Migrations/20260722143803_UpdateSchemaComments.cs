...
{
    /// <inheritdoc />
    public partial class UpdateSchemaComments : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<string>(
                ...
                oldMaxLength: 50,
                oldComment: "instance-started | task-created | task-claimed | task-completed | instance-completed");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<string>(
                ...
                maxLength: 50,
                nullable: false,
                comment: "instance-started | task-created | task-claimed | task-completed | instance-completed",
                oldClrType: typeof(string),
                oldType: "character varying(50)",
                oldMaxLength: 50,
